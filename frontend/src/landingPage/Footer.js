    ...
    <div className="footer container-fluid border-top pt-4 pt-md-5 pb-3 bg-body-tertiary">
      <div className="row mb-4 mb-md-5 g-4 row-cols-1 row-cols-sm-2 row-cols-lg-5 linksInRow px-2 px-sm-3">
        ...
        <div className="col">
          ...
          <br />
          <a className="anchorTagMain" href="">NRI demat account</a>
          <br />
          <a className="anchorTagMain" href="">Commodity</a>
          <br />
          <a className="anchorTagMain" href="">Dematerialisation</a>
          <br />
          <a className="anchorTagMain" href="">Fund transfer</a>
          <br />
          <a className="anchorTagMain" href="">MTF</a>
          <br />
          <a className="anchorTagMain" href="">Referral program</a>
          <br />
        </div>
        <div className="col">
          ...
          <br />
          <a className="anchorTagMain" href="">How to file a complaint?</a>
          <br />
          <a className="anchorTagMain" href="">Status of your complaints</a>
          <br />
          <a className="anchorTagMain" href="">Bulletin</a>
          <br />
          <a className="anchorTagMain" href="">Circular</a>
          <br />
          <a className="anchorTagMain" href="">Z-Connect blog</a>
          <br />
          <a className="anchorTagMain" href="">Downloads</a>
          <br />
        </div>
        <div className="col">
          ...
          <br />
          <a className="anchorTagMain" href="">Press & media</a>
          <br />
          <a className="anchorTagMain" href="">Careers</a>
          <br />
          <a className="anchorTagMain" href="">Zerodha Cares (CSR)</a>
          <br />
          <a className="anchorTagMain" href="">Zerodha.tech</a>
          <br />
          <a className="anchorTagMain" href="">Open source</a>
          <br />
        </div>
        <div className="col">
          ...
          <br />
          <a className="anchorTagMain" href="">Market holidays</a>
          <br />
          <a className="anchorTagMain" href="">Economic calendar</a>
          <br />
          <a className="anchorTagMain" href="">Calculators</a>
          <br />
          <a className="anchorTagMain" href="">Markets</a>
          <br />
          <a className="anchorTagMain" href="">Sectors</a>
          <br />
        </div>
      </div>
